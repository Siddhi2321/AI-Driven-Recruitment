        ...
        if history.empty:
            ...
            for idx, row in history.iterrows():
                with st.expander(f"Job: {row['job_title']} - {row['timestamp']}"):
                    st.text_area("Job Description", value=row["description"], height=100, disabled=True, key=f"description_{idx}")
                    try:
...
def main():
    ...
    if not st.session_state["authenticated"]:
        ...
        with col1:
            st.write("### 🚀 AI Resume Ranker Pro — Smarter Hiring Starts Here")
            st.markdown("""
                Unlock the power of **AI-driven recruitment** with an all-in-one platform:
                - 🧠 **Resume Analyzer** – Instantly rank and evaluate resumes based on job-fit.
                - 📝 **Resume Builder** – Create professional, customized resumes in minutes.
                - 🔗 **LinkedIn Analyzer** – Gain insights from public profiles for smarter decisions.
    
                **Why choose us?**
                - 🎯 **Match the best candidates** to your job openings, automatically.
                - ⏱️ **Save hours of manual screening** with intelligent automation.
                - 📊 **Data-driven hiring** decisions powered by NLP and AI.
                - 🔍 **Track history and performance** for better recruitment strategy.
                """)
